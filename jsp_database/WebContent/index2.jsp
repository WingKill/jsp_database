							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">							
											<img src="${pageContext.request.contextPath}/images/home/product${empdao.random}.jpg" alt="" />									
											<h2>
												$${emp.sal}									
											</h2>
											<p>${emp.ename}</p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>${emp.hiredate}</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>$${emp.sal} + $${emp.comm}</h2>
												<p>${empdao.empDeptMember(emp).getDeptno()} : ${empdao.empDeptMember(emp).dname}</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>${empdao.empDeptMember(emp).loc}</a>
											</div>
										</div>
								</div>
								<div class="choose">
